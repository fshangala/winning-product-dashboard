      ...
      <form id="email-form" name="email-form" data-name="Email Form" method="get" className="dashboard_form shadow-container" aria-label="Email Form">
        <div className="filters mb-3">
          ...
          <div className="select-wrapper">
            ...
            <select id="searchkeyword" name="searchkeyword" placeholder="Search Keyword In..." data-name="keywordsearchin" className="form-input select-box-2 w-select hidden select2-hidden-accessible" data-select2-id="searchkeyword" tabindex="-1" aria-hidden="true">
            ...
            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="1" style={{width:"130px"}}>
              <span className="selection">
                <span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-searchkeyword-container">
                  <span className="select2-selection__rendered" id="select2-searchkeyword-container" role="textbox" aria-readonly="true" title="All">
                    <span className="select2-selection__clear" title="Remove all items" data-select2-id="3">×</span>
                    All
                    </span>
          ...
          <div className="select-wrapper country-select">
            ...
            <select className="js-select2 form-input select-box-2 pb w-select hidden select2-hidden-accessible" multiple="" id="field" tabindex="-1" aria-hidden="true" data-select2-id="field">
            ...
            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="36" style={{width:"130px"}}>
              <span className="selection">
                <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false">
                  <ul className="select2-selection__rendered">
                    <li className="select2-search select2-search--inline">
          ...
          <div className="select-wrapper website-select">
            ...
            <select className="js-select2 form-input select-box-2 pb w-select hidden select2-hidden-accessible" multiple="" id="website" tabindex="-1" aria-hidden="true" data-select2-id="website">
            ...
            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="89" style={{width:"130px"}}>
              <span className="selection">
                <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false">
                  <ul className="select2-selection__rendered">
                    <li className="select2-search select2-search--inline">
                      <input className="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" placeholder="Select Website..." style={{width:"159.4px"}} />
                    </li>
                  </ul>
                </span>
              </span>
          ...
          <div className="select-wrapper language-select">
            ...
            <select className="js-select2 form-input select-box-2 pb w-select hidden select2-hidden-accessible" multiple="" id="language" tabindex="-1" aria-hidden="true" data-select2-id="language">
            ...
            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="101" style={{width:"130px"}}>
              <span className="selection">
                <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false">
                  <ul className="select2-selection__rendered">
                    <li className="select2-search select2-search--inline">
                      <input className="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" placeholder="Select Languages..." style={{width:"159.4px"}}/>
                    </li>
                  </ul>
                </span>
              </span>
          ...
          <div className="select-wrapper">
            ...
            <div className="div-block-71">
              <input type="text" aria-describedby="tooltip" data-dropdown-toggle="tooltip" className="form-input adset-count w-input dropdown select2-container select2-selection select2-selection--multipledropdowninitdropdowninitdropdowninitdropdowninitdropdowninit" maxlength="256" readOnly="" id="adsetsumary" value="1 - 2650" />
            </div>
            <div id="tooltip" className="hidden" style={{position:"absolute",inset:"0px auto auto 0px",margin:"0px",transform:"translate(1214px,321px)",padding:"15px",border:"medium",backgroundColor:"white",borderRadius:"0.5em",width:"350px",zIndex:"9998",boxShadow:"rgba(0, 0, 0, 0.1) 3px 3px 8px 0px"}} data-popper-placement="bottom">
              <div className="mt-4">
                <p className="text-sm mb-3 font-medium">Active Adset Amount</p>
                <div className="range-slider">
                    <div className="slider slide">
                      <div className="progress" style={{left:"2%",right:"33.9%"}} ></div>
                    </div>
                    <div id="total_likes_range" className="range-input range">
                    </div>
                    <div id="total_likes_values" className="price-input price">
                      <div className="select-wrapper">
                          <div className="div-block-71">
                            <input type="number" className="form-input select2-selection adset-count w-input itemsetcounter" maxlength="256" name="Min" data-name="Min" placeholder="Min" id="Min" required="" style={{width:"100%",marginTop:"10px"}} />
                          </div>
                      </div>
                    </div>
                    <div className="select-wrapper">
                      <div className="div-block-71">
                        <input type="number" className="form-input select2-selection adset-count w-input itemsetcounter" maxlength="256" name="Max" data-name="Max" placeholder="Max" id="Max" required="" style={{width:"100%",marginTop:"10px"}} />
                      </div>
                  </div>
                </div>
              </div>
          ...
          <div className="select-wrapper">
            <div className="select-label inline-flex items-center min-w-full gap-0.5 has-popup cursor-pointer">
              ...
              <div className="div-block-71">
                <input type="text" aria-describedby="tooltipadspend" data-dropdown-toggle="tooltipadspend" className="form-input adset-count w-input dropdown select2-container select2-selection select2-selection--multipledropdowninitdropdowninitdropdowninitdropdowninitdropdowninit" maxlength="256" readOnly="" id="adspendsummary" value="0$ - 999999$" />
              </div>
              <div id="tooltipadspend" className="hidden" style={{position:"relative",inset:"0px auto auto 0px",margin:"0px",transform:"translate(154px,374px)",padding:"15px",border:"medium",backgroundColor:"white",borderRadius:"0.5em",width:"350px",zIndex:"9998",boxShadow:"rgba(0, 0, 0, 0.1) 3px 3px 8px 0px"}} data-popper-placement="bottom">
                <div className="mt-4">
                  <p className="text-sm mb-3 font-medium">Enter adspend</p>
                  <div className="range-slider">
                      <div className="slider slide">
                        <div className="progress" style={{left:"2%",right:"33.9%"}}></div>
                      </div>
                      <div className="price-input price">
                        <div className="select-wrapper">
                            <div className="div-block-71">
                              <input type="number" className="form-input select2-selection adset-count w-input adspendcounter" maxlength="256" name="Minadspend" data-name="Minadspend" placeholder="Min" id="minadspend" required="" style={{width:"100%",marginTop:"10px"}} />
                            </div>
                        </div>
                      </div>
                      <div className="price-input price">
                        <div className="select-wrapper">
                          <div className="div-block-71">
                            <input type="number" className="form-input select2-selection adset-count w-input adspendcounter" maxlength="256" name="Maxadspend" data-name="Maxadspend" placeholder="Max" id="maxadspend" required="" style={{width:"100%",marginTop:"10px"}} />
                          </div>
                      </div>
                    </div>
                  </div>
          ...
          {/* <div style="position:relative;display:flex;" className="select-wrapper">
                <img src="https://app.winninghunter.com/images/premiumonly.png" className="image-3" style="z-index: 9999;object-fit: contain;position:absolute;top: -100px;left: -90px;height: 130px;pointer-events: none;">
                <div className="select-wrapper">
                  <div className="select-label">Trackable</div>
                  <span dir="ltr" data-select2-id="29" style="width: 100%;" className="select2 select2-container select2-container--default select2-container--focus select-2-skeleton"><span className="selection"><span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false"><ul className="select2-selection__rendered"><li className="select2-search select2-search--inline"><input className="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list"></li></ul></span></span><span className="dropdown-wrapper" aria-hidden="true"></span></span>
                  <select id="trackable" placeholder="Trackable Filter" name="trackable" data-name="trackable" className="form-input select-box-2 w-select hidden">
                    <option value="">None</option>
