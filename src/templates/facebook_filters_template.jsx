  ...
  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="dashboard_form shadow-container"
    ...
    <div class="filters mb-3">
      ...
      <div class="select-wrapper">
        ...
        <div id="tooltip" class="block" style="padding: 15px; border: medium; background-color: white; border-radius: 0.5em; width: 350px; z-index: 9998; box-shadow: rgba(0, 0, 0, 0.1) 3px 3px 8px 0px; position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(-82px, -43px);" data-popper-placement="top">
          <div class="mt-4">
            ...
            <div class="range-slider">
                ...
                <div id="total_likes_values" class="price-input price">
                  <div class="select-wrapper">
                      <div class="div-block-71">
                        <input type="number" class="form-input select2-selection adset-count w-input itemsetcounter" maxlength="256" name="Min" data-name="Min" placeholder="Min" id="Min" required="" style="width:100%;margin-top:10px;">
                      </div>
                  </div>
                </div>
                <div class="select-wrapper">
                  <div class="div-block-71">
                    <input type="number" class="form-input select2-selection adset-count w-input itemsetcounter" maxlength="256" name="Max" data-name="Max" placeholder="Max" id="Max" required="" style="width:100%;margin-top:10px;">
                  </div>
              </div>
            </div>
          </div>
    ...
    <div class="flex w-full justify-between">
      <div class="flex justify-between flex-wrap gap-1 pb-1 hidden-scroll mb-1 mt-3 preset-filters">
        <div data-active="false" id="euwinners"
          class="dropshipping whitespace-nowrap border-gray-300 hover:bg-gray-100 active:scale-[98%] h-9 px-3 cursor-pointer border border-input hover:text-accent-foreground inline-flex items-center justify-center rounded-full text-sm font-medium disabled:opacity-50 ring-offset-background hover:opacity-80">
        ...
        <div data-active="false" id="topbrands"
          class="dropshipping whitespace-nowrap border-gray-300 hover:bg-gray-100 active:scale-[98%] h-9 px-3 cursor-pointer border border-input hover:text-accent-foreground inline-flex items-center justify-center rounded-full text-sm font-medium disabled:opacity-50 ring-offset-background has-popup relative">
